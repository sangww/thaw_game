...
//--------------------------------------------------------------
void marioStage07::gotOSCMessage(ofxOscMessage m){
...
void marioStage07::draw(){
    ...
    if(ofGetSystemTime() - t_reset < 1000){
        ...
        ofSetColor(225);
        stage.assets->font.drawString("STAGE07", 500, 500);
    }
    else{
        //mario
        ofSetColor(255);
...
//--------------------------------------------------------------
void marioStage07::keyPressed  (int key){
...
//--------------------------------------------------------------
void marioStage07::keyReleased  (int key){
...
//--------------------------------------------------------------
void marioStage07::mouseMoved(int x, int y ){
}

//--------------------------------------------------------------
void marioStage07::mouseDragged(int x, int y, int button){
}

//--------------------------------------------------------------
void marioStage07::mousePressed(int x, int y, int button){
}

//--------------------------------------------------------------
void marioStage07::mouseReleased(int x, int y, int button){
}

void marioStage07::reset(){
