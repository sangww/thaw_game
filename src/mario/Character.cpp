...
void Character::draw(AssetManager* assets, float scaleFactorX, float scaleFactorY) {
    sprite.draw(x-(scaleFactorX-1.f)*48, y-(scaleFactorY-1.f)*48, assets, scaleFactorX, scaleFactorY);
}
...
void Character::setVelX(int val) {
	velX = val;
}

void Character::setVelY(int val) {
	velY = val;
}
