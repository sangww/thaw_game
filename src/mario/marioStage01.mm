...
//--------------------------------------------------------------
void marioStage01::setup(){
    ofEnableAlphaBlending();
    
    thaw = thawAppManager::getInstance();
    
    //spritemanager
    stage.setup("settings.xml", "stage01.xml");
...
//--------------------------------------------------------------
void marioStage01::update(){
    
	stage.update(thaw->phoneX+5, thaw->phoneY-10, thaw->phoneW, thaw->phoneH, thaw->angle);
...
//--------------------------------------------------------------
void marioStage01::gotOSCMessage(ofxOscMessage m){
...
void marioStage01::draw(){
    ...
    if(ofGetSystemTime() - t_reset < 1000){
        ...
        ofSetColor(225);
        stage.assets->font.drawString("STAGE01", 500, 500);
    }
    else{
        //mario
        ofSetColor(255);
...
//--------------------------------------------------------------
void marioStage01::keyPressed  (int key){
...
//--------------------------------------------------------------
void marioStage01::keyReleased  (int key){
...
//--------------------------------------------------------------
void marioStage01::mouseMoved(int x, int y ){
}

//--------------------------------------------------------------
void marioStage01::mouseDragged(int x, int y, int button){
}

//--------------------------------------------------------------
void marioStage01::mousePressed(int x, int y, int button){
}

//--------------------------------------------------------------
void marioStage01::mouseReleased(int x, int y, int button){
}

void marioStage01::reset(){
